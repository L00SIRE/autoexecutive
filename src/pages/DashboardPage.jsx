...
export default function DashboardPage() {
  ...
  return (
    <div className="scanlines min-h-screen flex flex-col">
      ...
      <div
        className="relative z-10 flex-1 p-1 flex flex-col gap-1 overflow-hidden"
      ...
      <button
        ...
        onClick={() => navigate("/")}
        className="fixed bottom-3 right-3 z-50 text-[10px] text-[#1a3a1a] border border-[#1a3a1a] px-3 py-1.5 hover:text-[#00ff41] hover:border-[#00ff41] transition-colors tracking-wider bg-black/80"
      >
        ← autoexecutive.io
      </button>
    </div>
